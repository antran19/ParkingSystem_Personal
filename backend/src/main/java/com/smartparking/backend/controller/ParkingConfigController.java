...
/**
 * ParkingConfigController — Cung cấp dữ liệu cấu hình bãi xe cho FE.
 * Route mới theo chuẩn RESTful: /api/v1/parking
 * Cho phép TẤT CẢ user đã authenticated truy cập để render map và danh sách loại xe, cổng.
 */
@RestController
...
public class ParkingConfigController {
     ...
     * Trả về toàn bộ cấu hình cần cho UI: loại xe, cổng, zone.
     */
